...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "ghidraremotesync.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ghidraremotesync.Grs.HelloRequest,
      ghidraremotesync.Grs.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = ghidraremotesync.Grs.HelloRequest.class,
      responseType = ghidraremotesync.Grs.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ghidraremotesync.Grs.HelloRequest,
      ghidraremotesync.Grs.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<ghidraremotesync.Grs.HelloRequest, ghidraremotesync.Grs.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<ghidraremotesync.Grs.HelloRequest, ghidraremotesync.Grs.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ghidraremotesync.Grs.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ghidraremotesync.Grs.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(ghidraremotesync.Grs.HelloRequest request,
        io.grpc.stub.StreamObserver<ghidraremotesync.Grs.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(ghidraremotesync.Grs.HelloRequest request,
        io.grpc.stub.StreamObserver<ghidraremotesync.Grs.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public ghidraremotesync.Grs.HelloReply sayHello(ghidraremotesync.Grs.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ghidraremotesync.Grs.HelloReply> sayHello(
        ghidraremotesync.Grs.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((ghidraremotesync.Grs.HelloRequest) request,
              (io.grpc.stub.StreamObserver<ghidraremotesync.Grs.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ghidraremotesync.Grs.HelloRequest,
              ghidraremotesync.Grs.HelloReply>(
